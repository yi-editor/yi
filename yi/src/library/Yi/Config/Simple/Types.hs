...
type FieldSetter a = Setting Config a
type FieldGetter a = Getting a Config Config a a
...
'makeLensesWithSuffix' "A" ''UserName

userName :: 'Field' 'String'
userName = ('customVariable' :: 'Field' 'UserName') '.' unUserNameA@
