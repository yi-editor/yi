...
keys =
  ...
  , ( "C-a",      atomic $ repeatingArg (maybeMoveB Line Backward))
  , ( "C-b",      atomic $ repeatingArg leftB)
  , ( "C-d",      atomic $ repeatingArg $ deleteN 1)
  , ( "C-e",      atomic $ repeatingArg (maybeMoveB Line Forward))
  ...
  , ( "C-n",      atomic $ repeatingArg $ moveB VLine Forward)
  , ( "C-o",      atomic $ repeatingArg (insertB '\n' >> leftB))
  , ( "C-p",      atomic $ repeatingArg $ moveB VLine Backward)
  , ( "C-q",      insertNextC)
  ...
  , ( "C-z",      atomic $ suspendEditor)
  , ( "C-x ^",    atomic $ repeatingArg enlargeWinE)
  , ( "C-x 0",    atomic $ closeWindow)
  , ( "C-x 1",    atomic $ closeOtherE)
  , ( "C-x 2",    atomic $ splitE)
  , ( "C-x C-c",  atomic $ quitEditor)
  ...
  , ( "M-t",      atomic $ repeatingArg $ transposeB Word Forward)
  ...
  , ( "<up>",     atomic $ repeatingArg (moveB VLine Backward))
  , ( "<down>",   atomic $ repeatingArg (moveB VLine Forward))
  , ( "C-<up>",   atomic $ repeatingArg $ prevNParagraphs 1)
  , ( "C-<down>", atomic $ repeatingArg $ nextNParagraphs 1)
  , ( "<next>",   atomic $ repeatingArg downScreenB)
  , ( "<prior>",  atomic $ repeatingArg upScreenB)
  ]
